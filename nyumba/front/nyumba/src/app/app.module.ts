...
import {AppWideReducer} from "../interfaces/app-wide-reducer";
  ...
  imports: [
    ...
    IonicModule.forRoot(ConferenceApp, {}, {
      links: [
        ...
        { component: QuestionViewPage, name: 'QuestionViewPage', segment: 'questionView' },
        { component: RoomSummaryPage, name: 'RoomSummaryPage', segment: 'roomSummary' },
        { component: TenantsPage, name: 'TenantsPage', segment: 'tenants' },
        { component: PaymentsPage, name: 'PaymentsPage', segment: 'payments' }
      ]
    }),
    IonicStorageModule.forRoot(),
    StoreModule.forRoot({stateReducer: AppWideReducer}),
    FormsModule,
