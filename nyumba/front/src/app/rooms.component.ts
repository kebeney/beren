...
export class RoomComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.state.componentName = 'Room';
    this.state.activeAddButtonText = this.state.addText + ' ' + this.state.componentName;
    this.state.getExistingRecords(this.roomService, '/getRooms');
    this.state.component = {
      num: this.state.componentArray.length,
      name: '',
      rent: '',
      status: 'New',
      occupant: 'Empty'
